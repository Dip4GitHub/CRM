            ...
            <div class="card-body">
              <table class="table table-hover progress-table mt-2">
                ...
                <tbody>
                  ...
                  $sql    = generateSql("SELECT customerName, customerId, sum(finalTotal) AS total FROM `crm_invoice_purchase` WHERE invoiceType ='1' group by customerId;");
