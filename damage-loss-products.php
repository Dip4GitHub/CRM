...
if ($keyword != '') {
  $whrQry = "WHERE name LIKE '%$keyword%' OR mobile LIKE '%$keyword%'";
}
  ...
  <script>
    ...
    function convertToCustomer(id) {
      if (confirm("Are You Sure You Want to Convert to Customer.")) {
        window.location = "customer-add.php?leadId=" + id;
      }
    }
  </script>
</head>
            ...
            <div class="card-body">
              <form name="frm" method="GET" autocomplete=off>
                <div class="search-container">
                  <input type="search" class="keyword" name="keyword" placeholder="Search By Name Or Mobile..." value="<?php echo $keyword; ?>">
              ...
              <table class="table table-hover progress-table mt-2">
                <thead class="text-uppercase bg-primary">
                  <tr class="text-white">
                    ...
                    <th scope="col">Convert To Customer</th>
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td><a target="_blank" href="https://wa.me/<?php echo $result->mobile; ?>"><?php echo $result->mobile; ?></a></td>
                        <td><?php echo $genderArray[$result->gender]; ?></td>
                        <td><?php if ($result->activeStatus < 3) {
                              echo $statusArray[$result->activeStatus];
                            } ?></td>
                        <td><?php echo $result->companyName; ?></td>
                        <td align="center"><?php if ($result->activeStatus != 3) { ?><a href="#" onclick="convertToCustomer(<?php echo $result->id; ?>)" class="text-secondary"><span class="pc-micon"> <i data-feather="corner-right-up"></i></span></a><?php } else {
                                                                                                                                                                                                                                                    echo "Converted to Customer";
                                                                                                                                                                                                                                                  } ?></td>
