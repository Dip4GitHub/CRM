...
$pageTitle      = 'Invoice & Expence';
$tableName      = generateSql('#__invoice_purchase');
$currentPage    = 'invoice-expence';
        ...
        <div class="col-span-12">
          <div class="card">
            ...
            <div class="card-header">
              <div class="col-lg-6">
                <h4 class="header-title"><?php echo getName('customerName', $tableName, $id); ?></h4>
              </div>
            </div>
            <?php
            ...
            <div class="card-body">
              ...
              <div class="grid grid-cols-12 gap-1.5 mt-5">
                ...
                <div class="sm:col-span-3 my-1">
                  <p><strong><?php echo $result->customerName; ?></strong></p>
                </div>
                <div class="sm:col-span-3 my-1">
                  <p>branchId: </p>
                </div>
