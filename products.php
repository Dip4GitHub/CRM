            ...
            <div class="card-body">
              ...
              <table class="table table-hover progress-table mt-2">
                ...
                <tbody>
                  <?php
                  // BOF :: Pagination 
                  $query      = $Dbconnect->query("SELECT id FROM $tableName WHERE productType = 1 $whrQry");
                  $totalRows  = $query->num_rows;
                  $pagination =  new Pagination(array('baseURL' => $currentPage . '.php', 'totalRows' => $totalRows, 'perPage' => $limitperpage));
                  // EOF :: Pagination 

                  $i = 1;
                  $sql    = generateSql("SELECT * FROM `$tableName` WHERE productType = 1 $whrQry");
                  ...
                  ?>
                      <tr>
                        ...
                        <td><?php echo $productUnitArray[$result->unit]; ?></td>
