...
if ($keyword != '') {
  $whrQry = "WHERE name LIKE '%$keyword%' OR billStart LIKE '%$keyword%'";
}
            ...
            <div class="card-body">
              <form name="frm" method="GET" autocomplete=off>
                <div class="search-container">
                  <input type="search" class="keyword" name="keyword" placeholder="Search By Name Or BillStart..." value="<?php echo $keyword; ?>">
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td><?php echo $result->billStart; ?></td>
