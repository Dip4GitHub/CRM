...
$pageTitle      = 'Packagimg Material Purchase';
...
if ($submit == 'Add' or $submit == 'Update') {
  $commonQry  = "`salePurchaseDate`='$salePurchaseDate', `vendorName`='$vendorName', `vendorId`='$vendorId', `invoiceNo`='$invoiceNo', `finalTotal`='$finalTotal', `branchId`='$BranchID', invoiceType = 3";
...
<body>
  ...
  <script>
    ...
    function getProductName(el) {
      ...
      const xhr = new XMLHttpRequest();
      xhr.open("GET", "includes/ajax/getProductName.php?productType=3&q=" + encodeURIComponent(el.value), true);
