...
$pageTitle      = 'Vendors Reports';
$tableName      = generateSql('#__invoice_purchase');
$currentPage    = 'vendors-report';
            ...
            <div class="card-body">
              <table class="table table-hover progress-table mt-2">
                ...
                <tbody>
                  ...
                  $sql    = generateSql("SELECT vendorName, vendorId, sum(finalTotal) AS total, productName FROM `crm_invoice_purchase` WHERE invoiceType IN (2,3) group by vendorId ORDER BY id");
