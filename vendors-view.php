          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="grid grid-cols-12 gap-1.5 mt-5">
                ...
                <div class="sm:col-span-3 my-1">
                  <p><strong><?php echo $vendorsTypeArray[$result->vendorsType]; ?></strong></p>
                </div>
                <div class="sm:col-span-3 my-1">
                  <p>Gender: </p>
                </div>
                ...
                <div class="sm:col-span-3 my-1">
                  <p><strong><?php echo $result->gstNumber ?></strong></p>
                </div>
                <div class="sm:col-span-3 my-1">
                  <p>Address: </p>
                </div>
                ...
                <div class="sm:col-span-3 my-1">
                  <p><strong><?php echo $result->adharNo ?></strong></p>
                </div>
                <div class="sm:col-span-3 my-1">
                  <p>PAN No: </p>
                </div>
                <div class="sm:col-span-3 my-1">
                  <p><strong><?php echo $result->panNo ?></strong></p>
                </div>
                <div class="sm:col-span-3 my-1">
                  <p>Status: </p>
                </div>
                <div class="sm:col-span-3 my-1">
                  <p><strong><?php echo $statusArray[$result->activeStatus]; ?></strong></p>
                </div>
              </div>
